 ...
 *   Tests will use http://localhost:8087 (Quinoa Angular dev server)
 * 
 * - Maven integration: Run `mvn verify -Pe2e`
 *   Tests will use http://localhost:8087 (built Quarkus jar with H2 and static Angular files)
...
export default defineConfig({
  ...
  webServer: process.env.BASE_URL ? {
    ...
    url: 'http://localhost:8087/m/health',
