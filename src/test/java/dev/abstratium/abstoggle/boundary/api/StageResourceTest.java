...
class StageResourceTest {
    ...
    void testCreateStage_persistsStage() {
        ...
        given()
            ...
            .body(request)
            .queryParam("changeNote", "Creating stage via API")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(200)
    ...
    void testCreateStage_nullName_returns400() {
        ...
        given()
            .contentType("application/json")
            .body(request)
            .queryParam("changeNote", "Creating stage with null name")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(400)
    ...
    void testCreateStage_emptyName_returns400() {
        ...
        given()
            .contentType("application/json")
            .body(request)
            .queryParam("changeNote", "Creating stage with empty name")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(400)
    ...
    void testCreateStage_duplicateName_returns409() throws Exception {
        ...
        given()
            .contentType("application/json")
            .body(request)
            .queryParam("changeNote", "Creating duplicate stage")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(409)
    ...
    void testCreateStage_withParentStage() throws Exception {
        ...
        given()
            .contentType("application/json")
            .body(request)
            .queryParam("changeNote", "Creating stage with parent")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(200)
    ...
    void testCreateStage_withNonexistentParent_returns400() {
        ...
        given()
            .contentType("application/json")
            .body(request)
            .queryParam("changeNote", "Creating stage with nonexistent parent")
            .when()
            .post("/api/stages")
            .then()
            .statusCode(400)
