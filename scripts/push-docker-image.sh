...
docker push ghcr.io/abstratium-dev/abstoggle:$VERSION
docker push ghcr.io/abstratium-dev/abstoggle:latest
...
echo "  - ghcr.io/abstratium-dev/abstoggle:$VERSION"
echo "  - ghcr.io/abstratium-dev/abstoggle:latest"
